...
_ALL_IMG_DS_STATS = {
    ...
    ImgRegDatasets.SLC_SPACE: ((4.3368458e-13,), (5.503901e-12,)),
}
...
def load_image_dataset(split,
    ...
    ds, dataset_info = tfds.load(
        name, split=split, as_supervised=True, with_info=True, builder_kwargs=builder_kwargs)
