...
def _make_perdevice_likelihood_prior_grad_fns(net_apply, log_likelihood_fn,
    ...
    def likelihood_prior_and_grads_fn(params, net_state, batch, key):
...
def _make_perdevice_minibatch_log_prob_and_grad(
    ...
    def perdevice_log_prob_and_grad(dataset, params, net_state, key):
        likelihood, likelihood_grad, prior, prior_grad, net_state = (
            perdevice_likelihood_prior_and_grads_fn(params, net_state, dataset, key))
...
def make_get_predictions(activation_fn, num_batches=1, is_training=False):
    ...
    def get_predictions(net_apply, params, net_state, dataset, key):
